...
Last updated 2026-09-21. Not published to the docs site (`site/nav.mjs` is opt-in) because it changes often and carries operational detail.
...
| A7 | **FOL-26** | **Retire the Topics view.** Gated on A2's checklist — struck 2026-09-18: A3, FOL-35 (deferred), ~~FOL-36's `/message` half~~ (peek#268) and ~~FOL-14~~ (done 2026-09-20; only A3 and the deferred FOL-35 remain) — and on **B6** — the Topics view is the only reader of **184** messages (a live census reading; 202 when the project opened) and 62 attachments |
