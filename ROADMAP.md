...
| **MS4** | Take the topic half off Convex — SHR-5 (the largest *code* win) and SHR-6, joined 2026-09-16 by **SHR-9** (open work onto the layer-2 blob) and **SHR-10** (the Screener as a fold) | **Gated on MS2 — except SHR-9**, which is gated on nothing at all and is the cheapest way in. All four split cleanly from the DM branch |
